...
- `VISION.md` (repo root) is always the current version.
- Previous versions are archived in `docs/archive/vision/`.
...
- 2026-02-08: v1 scaffold created.
- 2026-02-08: v1 archived to `docs/archive/vision/VISION_v1.md`; current file advanced to v2 with maintainer fast-pass intent language.
