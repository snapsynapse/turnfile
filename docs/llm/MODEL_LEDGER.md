...
| Codex 5.5 | OpenAI Codex desktop | Codex protocol collaborator; sessions 14-28 inclusive. Session 14 close through session 28 boot. Handshake payloads sometimes self-report as "GPT-5"; Maintainer confirmed canonical label is "Codex 5.5" (2026-06-23) | E4 | 2026-06-13 to 2026-06-23 | `working-session/WORKLOG.md`; `working-session/TURNFILE.yaml`; `working-session/MAILBOX.md` |
